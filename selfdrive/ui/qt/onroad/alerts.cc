...
void OnroadAlerts::updateState(const UIState &s) {
  try {
    ...
    std::cerr << "Exception in OnroadAlerts::updateState: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in OnroadAlerts::updateState." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void OnroadAlerts::clear() {
  try {
    ...
    std::cerr << "Exception in OnroadAlerts::clear: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in OnroadAlerts::clear." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void OnroadAlerts::paintEvent(QPaintEvent *event) {
  try {
    ...
    std::cerr << "Exception in OnroadAlerts::paintEvent: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in OnroadAlerts::paintEvent." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
