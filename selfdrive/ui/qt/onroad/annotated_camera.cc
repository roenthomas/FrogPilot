...
void AnnotatedCameraWidget::updateState(int alert_height, const UIState &s) {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::updateState: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::updateState." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
...
void AnnotatedCameraWidget::drawHud(QPainter &p) {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::drawHud: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::drawHud." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void AnnotatedCameraWidget::drawText(QPainter &p, int x, int y, const QString &text, int alpha, bool overridePen) {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::drawText: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::drawText." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void AnnotatedCameraWidget::initializeGL() {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::initializeGL: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::initializeGL." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void AnnotatedCameraWidget::updateFrameMat() {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::updateFrameMat: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::updateFrameMat." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void AnnotatedCameraWidget::drawLaneLines(QPainter &painter, const UIState *s, float v_ego) {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::drawLaneLines: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::drawLaneLines." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void AnnotatedCameraWidget::drawDriverState(QPainter &painter, const UIState *s) {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::drawDriverState: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::drawDriverState." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void AnnotatedCameraWidget::drawLead(QPainter &painter, const cereal::RadarState::LeadData::Reader &lead_data, const QPointF &vd, float v_ego, const QColor &lead_marker_color, bool adjacent) {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::drawLead: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::drawLead." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void AnnotatedCameraWidget::paintEvent(QPaintEvent *event) {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::paintEvent: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::paintEvent." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void AnnotatedCameraWidget::showEvent(QShowEvent *event) {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::showEvent: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::showEvent." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void AnnotatedCameraWidget::updateSignals() {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::updateSignals: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::updateSignals." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void AnnotatedCameraWidget::updateFrogPilotVariables(int alert_height, const UIScene &scene) {
  try {
    if (is_metric || useSI) {
      ...
      leadDistanceUnit = mapOpen ? tr("m") : tr("meters");
      ...
      leadDistanceUnit = mapOpen ? tr("ft") : tr("feet");
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::updateFrogPilotVariables: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::updateFrogPilotVariables." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void AnnotatedCameraWidget::paintFrogPilotWidgets(QPainter &painter) {
  try {
    ...
    std::cerr << "Exception in AnnotatedCameraWidget::paintFrogPilotWidgets: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in AnnotatedCameraWidget::paintFrogPilotWidgets." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void PedalIcons::updateState(const UIScene &scene) {
  try {
    ...
    std::cerr << "Exception in PedalIcons::updateState: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in PedalIcons::updateState." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
...
void PedalIcons::paintEvent(QPaintEvent *event) {
  try {
    ...
    std::cerr << "Exception in PedalIcons::paintEvent: " << e.what() << std::endl;
    params_memory.putBool("DebugUI", true);
  } catch (...) {
    std::cerr << "Unknown exception in PedalIcons::paintEvent." << std::endl;
    params_memory.putBool("DebugUI", true);
  }
}
